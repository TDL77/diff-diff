...
- **Shipped**: SpilloverDiD + Conley + survey via Wave E.1/E.2/E.3 (PR #468 / #474 / #482, stratified-Conley sandwich on PSU totals with within-PSU serial Bartlett HAC for `lag_cutoff > 0`); TwoStageDiD + Conley + survey via Wave E.3 parity (PR #485 / `fdf2cebc`).
