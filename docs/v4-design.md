...
9. **A rename carries to every surface that mirrors it.** Renaming a
   ...
   (mirrors [M-043]), [M-114] (mirrors [M-033]), [M-143] (mirrors [M-015] -
   the field already held the tag the new `method=` param sets). When adding a rename row,
...
[M-070]..[M-077], [M-082],
[M-084], [M-086]..[M-089], [M-094] [M-095], [M-097]..[M-115], [M-143]). Rows with no
shim to assert gate
